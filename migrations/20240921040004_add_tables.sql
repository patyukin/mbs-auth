...
(
    id         UUID DEFAULT uuid_generate_v4() PRIMARY KEY,
    user_id    UUID      NOT NULL REFERENCES users (id) ON UPDATE CASCADE ON DELETE NO ACTION,
    role_id    UUID      NOT NULL REFERENCES roles (id) ON UPDATE CASCADE ON DELETE NO ACTION,
    created_at TIMESTAMP NOT NULL,
...
VALUES ('/auth/users-roles', 'GET', NOW()),
       ...
       ('/payments/{id}', 'GET', NOW()),
       ('/payments/{id}', 'PUT', NOW()),
       ('/payments/{id}', 'DELETE', NOW()),
       ('/accounts', 'GET', NOW()),
       ('/accounts', 'POST', NOW()),
       ('/accounts/{id}', 'GET', NOW()),
       ('/accounts/{id}', 'PUT', NOW()),
       ('/accounts/{id}', 'DELETE', NOW()),
       ('/transactions', 'GET', NOW()),
       ('/transactions/{id}', 'GET', NOW()),
...
VALUES ((SELECT id FROM roles WHERE name = 'sys-admin'),
        (SELECT id FROM permissions WHERE route_path = '/auth/users-roles' AND method = 'GET'), NOW()),
       ((SELECT id FROM roles WHERE name = 'sys-admin'),
       ...
       ((SELECT id FROM roles WHERE name = 'superuser'),
        (SELECT id FROM permissions WHERE route_path = '/payments' AND method = 'GET'), NOW()),
       ((SELECT id FROM roles WHERE name = 'superuser'),
        (SELECT id FROM permissions WHERE route_path = '/payments' AND method = 'POST'), NOW()),
       ((SELECT id FROM roles WHERE name = 'superuser'),
        (SELECT id FROM permissions WHERE route_path = '/payments/{id}' AND method = 'POST'), NOW()),
       ((SELECT id FROM roles WHERE name = 'superuser'),
        (SELECT id FROM permissions WHERE route_path = '/payments/{id}' AND method = 'PUT'), NOW()),
       ((SELECT id FROM roles WHERE name = 'superuser'),
        (SELECT id FROM permissions WHERE route_path = '/payments/{id}' AND method = 'DELETE'), NOW()),
       ((SELECT id FROM roles WHERE name = 'user'),
        (SELECT id FROM permissions WHERE route_path = '/payments' AND method = 'GET'), NOW()),
       ((SELECT id FROM roles WHERE name = 'user'),
        (SELECT id FROM permissions WHERE route_path = '/payments' AND method = 'POST'), NOW()),
       ((SELECT id FROM roles WHERE name = 'user'),
        (SELECT id FROM permissions WHERE route_path = '/payments/{id}' AND method = 'GET'), NOW()),
       ((SELECT id FROM roles WHERE name = 'user'),
        (SELECT id FROM permissions WHERE route_path = '/payments/{id}' AND method = 'PUT'), NOW()),
       ((SELECT id FROM roles WHERE name = 'user'),
        (SELECT id FROM permissions WHERE route_path = '/payments/{id}' AND method = 'DELETE'), NOW())
